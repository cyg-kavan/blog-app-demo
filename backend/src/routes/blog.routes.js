...
const { createBlog, updateBlog, deleteBlog, showBlog, blogListing, getBlogById } = require("../controllers/blog.controller")
const authentication = require("../middlewares/auth.middleware");
const authorizeRoles = require("../middlewares/rbac.middleware");

router.get("/", blogListing);
router.get("/my-blogs", authentication, blogListing);
router.get("/:blogId", authentication, getBlogById);
